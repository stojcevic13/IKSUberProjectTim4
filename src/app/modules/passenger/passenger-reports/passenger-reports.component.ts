...
import { Ride } from '../passenger-ride-history/passenger-ride-history.component';
...
export class PassengerReportsComponent {
  ...
  onSubmit(){ 
      ...
      let sumCost = 0;
      let sumKilometers = 0;
      this.rideService.getPassengerRidesByDate(startDate, endDate, this.userId).subscribe(({
          next: (rides) => {
              this.rides= rides;
